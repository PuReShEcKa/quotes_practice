...
4. При необходимости отметьте "В избранное".
...
![Добавление цитаты](screenshot2.png)
Рисунок 2 – Добавление цитаты

Загрузка изображения:

![Изображение автора](screenshot3.png)
Рисунок 3 – Отображение загруженного изображения
